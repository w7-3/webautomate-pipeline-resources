...
1. **Global Documentations**: A single vector that contains are stable files that are not changed often and are used by all users. They are stored in the `global` folder.
